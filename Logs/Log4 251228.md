# GDMS nano – Development Log & Architecture Notes  
**Author:** Alexander Sousa  
**Date:** 2025  
**Platform:** Arduino Nano–class (ATmega328P, Elegoo Nano clone)  
**Display:** SSD1306 128×64 OLED (I²C) using U8x8 text mode  

---

Important Note -- Project pivotted from GDMS pocket to GDMS nano to create something that could exist on an elegoo nano clone independent of SD cards. a standalone device with no adaptive menus or user-addable content. 


## 1. Project Goal (High-Level)

GDMS nano is a **single-purpose, table-facing Dungeon Master aid** designed to provide:
...
**MCU:** ATmega328P (Elegoo Nano clone)  
- Flash: ~30 KB usable  
- SRAM: 2 KB total  
...
**GDMS nano suggests. The DM decides.**
